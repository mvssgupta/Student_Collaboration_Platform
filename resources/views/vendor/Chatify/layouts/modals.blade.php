...
<div id="imageModalBox" class="imageModal">
  ...
  {{-- ---------------------- Logout Modal ---------------------- --}}
  <div class="app-modal" data-name="scplogout">
    <div class="app-modal-container">
        <div class="app-modal-card" data-name="scplogout" data-modal='0'>
            <div class="app-modal-header">Are you sure you want to logout</div>
            {{-- <div class="app-modal-body">You can not undo this action</div> --}}
            <div class="app-modal-footer">
                <a href="javascript:void(0)" class="app-btn cancel">Cancel</a>
                <a onclick="event.preventDefault();
                document.getElementById('logout-form').submit();" class="app-btn a-btn-danger delete">Logout</a>
          ...
          <div class="app-modal-card" data-name="settings" data-modal='0'>
              <form id="update-settings" action="{{ route('avatar.update') }}" enctype="multipart/form-data" method="POST">
                  ...
                  <div class="app-modal-body">
                      ...
                      style="background-image: url('{{ Auth::user()->profilepic }}');"
                      ></div>
