...
<div class="messenger">
    ...
    <div class="messenger-listView">
        ...
        <div class="m-header">
            <nav>
                <a href="#"><i class="fas fa-inbox"></i> <span class="messenger-headTitle">SCP</span> </a>
                {{-- header buttons --}}
                <nav class="m-header-right">
                    <a href="#"><i class="fas fa-cog settings-btn"></i></a>
                    <a href="#"><i class="fas fa-sign-out-alt scplogout"></i></a>
        ...
        <div class="m-body contacts-container">
           ...
           <div class="@if($type == 'group') show @endif messenger-tab groups-tab app-scroll" data-view="groups">
                ...
                {{-- <p style="text-align: center;color:grey;margin-top:30px">
                    <a target="_blank" style="color:{{$messengerColor}};" href="#">Under devlopment</a>
                </p> --}}
                {{-- Contact --}}
               <div class="listOfGroups" style="width: 100%;height: calc(100% - 200px);position: relative;"></div>
             </div>
        ...
        <div class="m-header m-header-messaging">
            <nav>
                ...
                <nav class="m-header-right">
                    ...
                    <a href="/scp"><i class="fas fa-home"></i></a>
